...
export default function SideBar(props) {
    ...
    const handleSalesByHour = () => {
        ...
        props.setDisplaySalesByHour('inline');
        // props.setCurrentPage('SalesByHour');
        handleDrawerClose();
    ...
    const handleSalesByCategory = () => {
        props.setDisplaySalesByCategory('inline');
        props.setDisplaySalesByHour('none');
        // props.setCurrentPage('SalesByCategory');
        handleDrawerClose();
    ...
    function handlePageChange(e) {
        ...
        switch (e.target.textContent) {
            case 'Sales By Hour': handleSalesByHour();
                break;
            case 'Sales By Category': handleSalesByCategory();
                break;
        }
